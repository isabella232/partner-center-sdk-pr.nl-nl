...
| status               | tekenreeks                                                        | De status van het abonnement: 'none', 'active', 'pending', 'suspended', 'expired' of 'deleted'.                                                                                                         |
...
| suspensionReasons    | tekenreeksmatrix                                              | Alleen-lezen. Als het abonnement is opgeschort, geeft aan waarom.                                                                                                                  |
...
| consumptionType  | matrix met [resources voor uitval](subscription-resources.md#overage)   | Hiermee wordt uitval voor een bepaalde klant in- ofsets.     |
...
De **uitvalresource** vertegenwoordigt de uitval van het verbruiksabonnement dat kan worden toegewezen aan, ongeacht of deze is toegewezen en aan de reseller is toegewezen.

| Eigenschap        | Type               | Beschrijving                                                                     |
|-----------------|--------------------|---------------------------------------------------------------------------------|
| azureEntitlementId | tekenreeks       | Een tekenreeks met GUID-indeling die de id van het verbruiksabonnement aangeeft. |
| partnerId    | tekenreeks            | De Microsoft Partner Network (MPN) van de reseller die is gekoppeld aan het abonnement.        |
| type    | tekenreeks       | Het type uitval kan PhoneServices zijn       |
| Overage            | booleaans      | Een waarde die aangeeft of uitval is ingeschakeld.       |
| Verwijzigingen           | [ResourceLinks](utility-resources.md#resourcelinks)            | De aan uitval gerelateerde koppelingen.                          |
