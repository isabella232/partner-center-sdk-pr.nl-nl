...
|------------------------|----------|----------|--------------------------------------------------------------------------------------------------------------------------------------------------------|
| CustomerTenantId | guid | J        | De waarde is een **CustomerTenantId** met GUID-indeling waarmee u een klant kunt opgeven. |
...
| [DomainFederationSettings](#domain-federation-settings) | object | Ja (als AuthenticationType = `Federated` )     | De domeinfederatie-instellingen die moeten worden gebruikt als het domein een domein is `Federated` en geen `Managed` domein. |
...
| IsDefault                                             | booleaanse waarde die null is | Nee       | Geeft aan of het domein het standaarddomein voor de tenant is. Ondersteunde waarden: `True` `False` , , `Null` .        |
| IsInitial                                             | booleaanse waarde die null is | Nee       | Geeft aan of het domein een eerste domein is. Ondersteunde waarden: `True` `False` , , `Null` .                       |
...
| LogOffUri                              | tekenreeks           | Ja     | De aanmeldings-URI. Deze eigenschap beschrijft de URI voor het uitloggen van federatief domein.        |
...
| SigningCertificate                     | tekenreeks           | Ja     | Het certificaat dat momenteel wordt gebruikt door de ADFS V2 STS om claims te ondertekenen. Deze eigenschap is een base64-gecodeerde weergave van het certificaat. |
| SigningCertificateUpdateStatus         | tekenreeks           | No      | Hiermee wordt de updatestatus van het handtekeningcertificaat aangegeven. |
| SigningCertificateUpdateStatus         | booleaanse waarde null-waarde | Nee      | Geeft aan of de IDP STS MFA ondersteunt. Ondersteunde waarden: `True` , `False` , `Null` .|
