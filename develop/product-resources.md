...
| dynamicAttributes      | sleutel-waardeparen  | De woordenlijst met dynamische eigenschappen die van toepassing zijn op dit item. De eigenschappen in deze woordenlijst zijn dynamisch en kunnen zonder kennisgeving worden gewijzigd. Maak geen sterke afhankelijkheden van bepaalde sleutels die bestaan in de waarde van deze eigenschap.    |
...
| segment         | tekenreeks                        | Het segment in de branche voor deze beschikbaarheid. Ondersteunde waarden zijn: Commercieel, Onderwijs, Overheid, NonProfit. |
...
Vertegenwoordigt de details van een inventarisbeperking. Dit is alleen van toepassing op uitvoerresultaten van de inventariscontrole, niet voor invoeraanvragen.
