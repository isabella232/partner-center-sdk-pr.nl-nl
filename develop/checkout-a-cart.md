...
Een bestelling voor een klant in een winkelwagen afrekenen.
...
Als u een bestelling voor een klant wilt afrekenen, krijgt u een verwijzing naar de winkelwagen met behulp van de winkelwagen en de klant-id. Roep ten slotte de functies **Create** of **CreateAsync aan** om de order te voltooien.
...
Als u een bestelling voor een klant wilt afrekenen, krijgt u een verwijzing naar de winkelwagen met behulp van de winkelwagen en de klant-id. Roep ten slotte de **functie create aan** om de bestelling te voltooien.
...
Als u een order voor een klant wilt afrekenen, voert u [**Submit-PartnerCustomerCart uit om**](https://github.com/Microsoft/Partner-Center-PowerShell/blob/master/docs/help/Submit-PartnerCustomerCart.md) de order te voltooien.
...
| **cart-id**     | tekenreeks   | Yes      | Een met GUID opgemaakte cart-id die de winkelwagen identificeert.                     |
