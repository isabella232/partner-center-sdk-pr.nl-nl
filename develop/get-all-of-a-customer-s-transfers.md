...
Een lijst met de overdrachten van een klant ophalen.
...
Als deze methode is geslaagd, wordt een lijst met [TransferEntity](transfer-entity-resources.md) -resources in de antwoord tekst geretourneerd.
