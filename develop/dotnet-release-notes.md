...
ms.locfileid: "115991216"
---
# <a name="net-sdk-release-notes"></a>Releasenotities voor .NET SDK

De volgende release-opmerkingen zijn beschikbaar voor nieuwe versies van [Microsoft Partner Center .NET SDK.](https://www.nuget.org/packages/Microsoft.Store.PartnerCenter) U vindt [.NET SDK-voorbeelden](https://github.com/Microsoft/Partner-Center-DotNet-Samples) op GitHub. U vindt de [naslaginformatie Partner Center .NET API](/dotnet/api/?view=partnercenter-dotnet-latest&preserve-view=true) in de .NET API-browser.
...
> [!NOTE]
> Sommige wijzigingen die zijn geïntroduceerd als onderdeel van New Commerce Experiences ('REVIEW'), die momenteel beschikbaar zijn op basis van een uitnodiging alleen voor partners die deel uitmaken van de M365/D365 New Commerce Experience Technical Preview. Partners die geen deel uitmaken van de private preview van New Commerce, mogen geen gevolgen merken en moeten achterwaarts compatibel zijn.
...
* [Regelitems voor facturen:](get-invoiceline-items.md) nieuwe kenmerken toegevoegd aan de volgende API's:
  ...
  * subscriptionEndDate
  * referenceId
  * creditReasonCode (alleen van toepassing op DROME)
  * promotionId 
...
* [Regelitems voor dagelijks beoordeeld gebruik:](get-invoice-billed-consumption-lineitems.md) nieuwe kenmerken toegevoegd aan de volgende API: 
  * `GET /invoices/{invoice-id}/lineitems?provider=onetime&invoicelineitemtype=usagelineitems`
  ...
  Nieuwe kenmerken: 
  * hasPartnerEarnedCredit (alleen van toepassing op PLEX)
  * creditType (alleen van toepassing op GEBRUIK)
  * rateOfCredit (alleen van toepassing op GOEDEN)
...
* [Een adres valideren:](validate-an-address.md) het antwoord is gewijzigd van een Booleaanse booleaanse in een nieuw model voor API:
...
* Bijgewerkte controle: nieuwe bewerkingstypen toegevoegd om te weten wanneer de klant DAP heeft goedgekeurd en beëindigd
  * [DapAdminRelationshipApproved](auditing-resources.md)
  * [DapAdminRelationshipTerminated](auditing-resources.md)

* Bijgewerkte controle: nieuwe resource- en bewerkingstypen toegevoegd voor de ondersteuning van het scenario van de klantdirectory-rol
...
* SDK-updates voor klantenaccount : ondersteuning voor de volgende API's
...
* **De volgende wijzigingen zijn geïntroduceerd als onderdeel van New Commerce. Deze zijn momenteel alleen beschikbaar op basis van een uitnodiging aan partners die deel uitmaken van de technische preview van de nieuwe commerce-ervaring M365/D365.** Partners die geen deel uitmaken van de private preview van New Commerce, mogen geen gevolgen merken en moeten achterwaarts compatibel zijn.
