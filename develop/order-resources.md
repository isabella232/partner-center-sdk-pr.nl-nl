...
| lineItems          | matrix van [OrderLineItem-resources](#orderlineitem) | Een gespecificeerde lijst met aanbiedingen die de klant aanschaft, inclusief de hoeveelheid.        |
...
| Friendlyname         | tekenreeks                                    | Optioneel. De gebruiksvriendelijke naam voor het abonnement dat is gedefinieerd door de partner om ondubbelzinnig te zijn.                                                                                                                                              |
...
| partnerIdOnRecord    | tekenreeks                                    | Wanneer een indirecte provider een bestelling plaatst namens een indirecte reseller, vult u dit veld in met de MPN-id van de **indirecte reseller** (nooit de id van de indirecte provider). Dit zorgt voor de juiste boekhouding voor incentives. |
...
| Eigenschap           | Type                                         | Description                                                                   |
|--------------------|----------------------------------------------|-------------------------------------------------------------------------------|
| provisioningStatus | [Koppeling](utility-resources.md#link)            | Wanneer deze is ingevuld, de koppeling om de inrichtingsstatus voor de order op te halen.       |
...
| sku                | [Koppeling](utility-resources.md#link)            | De koppeling voor het ophalen van SKU-informatie voor het gekochte catalogusitem.                    |
...
|--------------------|--------------|-------------------------------------------------|
| unknown            | 0            | Initialisatie van de enum.                               |
| Voltooid          | 1            | Geeft aan dat de order is voltooid.          |
| in behandeling            | 2            | Geeft aan dat de bestelling nog in behandeling is.      |
