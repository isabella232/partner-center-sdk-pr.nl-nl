...
In deze sectie worden de manieren beschreven waarop Cloud Solution Provider kunnen gebruiken om Partner Center klantenaccounts programmatisch te beheren.

## <a name="create-a-customer"></a>Een klant maken

- [Een resellerrelatie aanvragen](request-reseller-relationship.md)
- [Een relatie als reseller met een klant verwijderen](remove-a-reseller-relationship-with-a-customer.md)

## <a name="look-up-a-customer"></a>Een klant zoeken

- [Een klant op basis van id ophalen](get-a-customer-by-id.md)
- [Een klant op bedrijfsnaam of -domein krijgen](get-a-customer-by-name.md)
- [Een lijst met klanten ophalen](get-a-list-of-customers.md)

## <a name="manage-customer-orders-and-subscriptions"></a>Klantorders en -abonnementen beheren
...
- [Alle abonnementen van een klant op te halen](get-all-of-a-customer-s-subscriptions.md)
- [De bijnaam voor een abonnement bijwerken](update-the-nickname-for-a-subscription.md)

## <a name="manage-customer-account-details"></a>Klantaccountgegevens beheren
...
- [Het gebruiksbudget van een klant bijwerken](update-a-customer-s-usage-spending-budget.md)
...
- [Bevestiging krijgen van acceptatie door klant van Microsoft Cloud-overeenkomst](get-confirmation-of-customer-consent.md)
...
- [Gebruikersaccounts voor een klant verwijderen](delete-user-accounts-for-a-customer.md)
...
- [Controleren welke licenties zijn toegewezen aan een gebruiker](check-which-licenses-are-assigned-to-a-user.md)

## <a name="manage-a-customers-self-serve-policies"></a>Zelfhulpbeleid van een klant beheren
