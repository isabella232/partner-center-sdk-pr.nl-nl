...
Wordt gebruikt om de geschiedenis van overgangen voor een bepaalde klant en een bepaald abonnement op te halen. De geschiedenis bevat alle gebeurtenissen die zijn verwerkt voor de overgang. Dit biedt alleen ondersteuning voor abonnementsovergangen op basis van nieuwe commercelicenties.
...
[GET] klanten/{customerId}/subscriptions/{subscriptionId}/transitions
### <a name="request-syntax"></a>Aanvraagsyntaxis

| Methode   | Aanvraag-URI                                                                                                                         |
|----------|-------------------------------------------------------------------------------------------------------------------------------------|
| **TOEVOEGEN**  | [*{baseURL}*](partner-center-rest-urls.md)/v1/customers/{customer-tenant-id}/subscriptions/{subscriptoin-Id}/transitions HTTP/1.1 |
...
Als dit lukt, wordt de overgangsgeschiedenis van deze methode gebruikt.
